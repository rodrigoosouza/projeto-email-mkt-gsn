...
export function LeadTrackingJourney({ email, orgSlug }: LeadTrackingJourneyProps) {
  ...
  const { lead, events, loading, error } = useTrackingJourney(email, orgTablesList, orgSlug)
